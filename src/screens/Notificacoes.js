...
class Notificacoes extends Component
{
    ...
    async componentDidMount(){
        await API.post("/index_include_notificacoes").then(
            (res) => { this.setState({ doac: res.data})
        }).catch(
            (err) => console.log('Erro ao procurar doacoes')
        );
    }
    ...
    render(){
        ...
        <SafeAreaView style={styles.mae}>
            ...
            <View style={styles.areaTxt}>   
                <Text style={styles.textoTop}>Notificações</Text>
            </View> 
