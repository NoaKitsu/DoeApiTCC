...
// import { StyleSheet, Text, View, Image, Button, TouchableOpacity, SafeAreaView, FlatList, Dimensions } from 'react-native';
// import API from '../../API'
...
//                     { 
//                         // this.state.inst.map(NomeInstituicao => (
//                             <FlatList
