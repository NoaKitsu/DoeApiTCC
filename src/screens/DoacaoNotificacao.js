...
class DoacaoNotificacao extends Component {
    ...
    verInst = () => {
        Keyboard.dismiss()
        this.props.navigation.navigate('DoacaoDadosInst')
    }
            ...
            <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
                ...
                <View style={styles.modal}>
                    ...
                    <View style={styles.btnArea}>
                        <TouchableOpacity style={styles.buttom1} onPress={this.verInst}>
                            <Text style={styles.buttomText}>Ver instituição</Text>
                        </TouchableOpacity>
                    </View>
                    ...
                    <View style={styles.btnArea2}>
                        <TouchableOpacity style={styles.buttom2} onPress={this.closeDoa}>
                            <Text style={styles.buttomText1}>Fechar</Text>
                        </TouchableOpacity>
                    </View>
                </View>
...
export default connect(mapStateToProps, null)(DoacaoNotificacao)
